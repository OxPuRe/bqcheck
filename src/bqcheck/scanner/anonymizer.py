...
def anonymize_metadata(
    ...
    known_safe_fields = {
        ...
        "row_count",
        "dataset_access_entry_count",
        "dataset_identity_access_count",
        "dataset_special_group_count",
        "dataset_authorized_view_count",
        "dataset_cross_project_authorized_view_count",
        "dataset_authorized_dataset_count",
        "dataset_access_source",
